...
# The globing behaves differently in Linux based and windows based operating system, therefore we need to check the OS this code is going to run on
import os
def check_os():
    if os.name == 'nt':
        return 'Windows'
...
# This returns the dataset into python imaging library
...
# Convoultion+dense+output layer
